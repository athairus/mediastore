...
public class ManagerCLITestDriver {
    ...
    public static void main( String[] args ) {
        ...
        try {
            ...
            db.manager.add( new Movie( 11, "Jack Black", "Tenacious D isn't dead I swear", 104, "Documentary", 5, 300, 49.99, 200000, 2013 ), 11 );
            ...
            System.out.println( db.manager.getCustomerInfo( 1 ) );
