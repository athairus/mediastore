...
public class MediaViewerGUI extends JFrame implements ActionListener {
    ...
    public MediaViewerGUI( Media m, Customer c, boolean managerMode, boolean searchMode ) throws java.io.IOException, SQLException {

        super( "Mediastore" );

        MediaStoreGUI.loggedInCustomer.recalculateRanking();

        addWindowListener( new MediaViewerGUIExitHandler( managerMode, searchMode ) );
    ...
    private class MediaViewerGUIExitHandler extends WindowAdapter {
        ...
        public MediaViewerGUIExitHandler( boolean managerMode, boolean searchMode ) {
        ...
        public void windowClosing( WindowEvent e ) {
            ...
            if( searchMode == true ) {
                try {
                    MediaStoreGUI.searchGUI( managerMode, null );
                } catch( SQLException ex ) {
                    Logger.getLogger( MediaViewerGUI.class.getName() ).log( Level.SEVERE, null, ex );
                } catch( IOException ex ) {
                    Logger.getLogger( MediaViewerGUI.class.getName() ).log( Level.SEVERE, null, ex );
